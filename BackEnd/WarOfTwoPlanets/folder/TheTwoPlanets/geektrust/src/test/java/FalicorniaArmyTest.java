...
public class FalicorniaArmyTest {
    ...
    public void shouldExtractUnitTroopsFromInputStringAndCheckInputFormat() {
        /*
         * Enter valid/invalid input to check extractInput() method of class war.LengaburuArmyOptimization.FalicorniaArmy
         */
    ...
    public void shouldCheckValidInputUnitValues() {
        /*
         * Enter valid/invalid values in war.LengaburuArmyOptimization.FalicorniaArmy class constructor to check extractInput() method of class war.LengaburuArmyOptimization.FalicorniaArmy
         */

...
public class LengaburuArmyTest {
    ...
    public void shouldGetRequiredUnitValuesFromFalicorniaArmyUnits() {
        /*
         * Enter valid/invalid values in FalicorniaArmy class constructor to check getRequiredUnitValues() method of class LengaburuArmy
         */
    ...
    public void shouldCheckHorseUnitLimitAndNeighBoringUnitsForSupport() {
        /*
         * Enter valid/invalid values in FalicorniaArmy class constructor to check horseUnitsOptimization() method of class LengaburuArmy
         */
    ...
    public void shouldCheckElephantUnitLimitAndNeighBoringUnitsForSupport() {
        /*
         * Enter valid/invalid values in FalicorniaArmy class constructor to check elephantUnitsOptimization() method of class LengaburuArmy
         */
    ...
    public void shouldCheckArmouredTankUnitLimitAndNeighBoringUnitsForSupport() {
        /*
         * Enter valid/invalid values in FalicorniaArmy class constructor to check armouredTankUnitsOptimization() method of class LengaburuArmy
         */
    ...
    public void shouldCheckSlingGunUnitLimitAndNeighBoringUnitsForSupport() {
        /*
         * Enter valid/invalid values in FalicorniaArmy class constructor to check slingGunUnitsOptimization() method of class LengaburuArmy
         */
